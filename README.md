...
[![PWA Ready](https://img.shields.io/badge/📱_PWA-Installable-purple?style=for-the-badge)](https://personalbotai.github.io/go-learning-path/)
...
- 📖 **53 Idiomatic Lessons:** Structured curriculum spanning basic syntax to advanced concurrency patterns and microservices.
- 🎯 **Deep Idiomatic Go Quizzes:** 53 technical quizzes covering slice memory models, goroutines, channels, error wrapping `%w`, and escape analysis.
- 🎖️ **Graduation Certificate Generator:** High-resolution Canvas certificate generator with PNG & PDF export — gated strictly to 100% completion.
- 📱 **PWA & Offline Support:** Service Worker caching and installable Web App Manifest.
- 📊 **Progress Persistence:** Automatic status saving and lesson resuming using `localStorage`.
...
8. **Concurrency & Goroutines** — Goroutines, channels (buffered & unbuffered), `select`, `sync.WaitGroup`, `sync.Mutex`, `sync.RWMutex`.

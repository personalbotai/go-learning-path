...
async function runCode() {
    ...
    // Go can't run in browser - show expected output
    ...
    validation.innerHTML = '<i class="fas fa-info-circle mr-2"></i>Go tidak bisa dijalankan di browser. Menampilkan output yang diharapkan.';
}
